...
echo "JOB"
echo $JOB
#LINHA=`more $DIRE/terraprog |head -1`
#sed -i 1d $DIRE/terraprog

LINHA=`sed -n "/$JOB/p" $DIRE/terraprog`
echo "LINHA"
echo $LINHA
...
echo " "
 echo ""
        ...
        echo "------------------------------"
        echo ""
        station_drd_to_raw $ARG1 TERRA_CADU_"$ANO"_"$MES"_"$DIA"."$HORA"_"$MIN"_"$SEG"_CB11
