...
echo " "
echo " "
echo "Script para envio dos dados CBERS4A...."
echo " "
...
then
        ...
        echo "###########################################################################################################"
        echo " "
        echo "POR GENTILEZA! REPITA O COMANDO INFORMANDO O ARQUIVO QUE DESEJA EMPACOTAR (SINTAXE: transfere_cbers4a.sh <arquivo>)"
        echo " "
        echo "###########################################################################################################"
        echo "-----------------------------------------------------------------------------------------------------------"
        echo "-----------------------------------------------------------------------------------------------------------"
...
read ANO
echo " "
echo "IDENTIFIQUE O VDP USADO (1 ou 2)"
read VDPN
echo " "
echo "HORA (00-23)"
read HORA
...
# CBERS4A
        ...
        echo "------------------------------"
        echo ""
        nome_arquivo=CBERS_4A_DTS"$VDPN"_RAW_"$ANO"_"$MES"_"$DIA"."$HORA"_"$MIN"_"$SEG"_ETC2
        cp $1 /mnt/sir10/disco1/A1/enviadas/VHR"$VDPN"/$nome_arquivo
        echo ""
        echo ""
...
cd /mnt/sir10/disco1/A1/enviadas/VHR"$VDPN"
...
# rm -rf /mnt/sir13/disco1/A1/enviadas/VHR"$VDPN"/$nome_arquivo.md5_cba
